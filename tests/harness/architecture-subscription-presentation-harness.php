...
$expected_hooks = array(
    ...
    array('filter', 'product_type_selector', array($p, 'add_custom_product_type'), 10, 1),
    array('filter', 'woocommerce_product_class', array($p, 'map_custom_product_class'), 10, 2),
    array('action', 'woocommerce_custom_type_add_to_cart', 'woocommerce_simple_add_to_cart', 30, 1),
    array('action', 'admin_footer', array($p, 'custom_product_types'), 10, 1),
    array('filter', 'woocommerce_product_data_tabs', array($p, 'add_custom_data_tab'), 10, 1),
    array('action', 'woocommerce_product_data_panels', array($p, 'add_custom_data_panel'), 10, 1),
    array('action', 'woocommerce_process_product_meta', array($p, 'save_custom_field_data'), 10, 1),
    array('action', 'woocommerce_single_product_summary', array($p, 'display_custom_field_on_frontend'), 10, 1),
    array('filter', 'woocommerce_get_item_data', array($p, 'display_custom_data_in_cart'), 10, 2),
    array('action', 'woocommerce_checkout_create_order_line_item', array($p, 'save_custom_data_to_order_items'), 10, 4),

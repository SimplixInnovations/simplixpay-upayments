...
q5_assert(q5_contains($quality_record, '**Status:** Q11 / IMPLEMENTATION'), 'quality record advances beyond Q5');
q5_assert(q5_contains($status, '| Current program gate | **Full Automated Quality Platform — Q11** |'), 'project status advances beyond Quality Platform Q5');
q5_assert(q5_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q11**.'), 'README advances beyond Quality Platform Q5');
q5_assert(

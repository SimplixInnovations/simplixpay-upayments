...
q5_assert(q5_contains($quality_record, '**Status:** Q12 / IMPLEMENTATION'), 'quality record advances beyond Q5');
q5_assert(q5_contains($status, '| Current program gate | **Full Automated Quality Platform — Q12** |'), 'project status advances beyond Quality Platform Q5');
q5_assert(q5_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q12**.'), 'README advances beyond Quality Platform Q5');
q5_assert(

...
q13_assert(q13_git_blob_sha($q13_root . '/includes/Subscription/Cron/Scheduler.php') === '75be4ded83142f67a933be0e1c24cedc484f9a73', 'protected Scheduler blob remains exact');
...
q13_assert(q13_contains($status, '| Quality Platform Q16 migration-core analysis | **DONE / VERIFIED** |'), 'project status advances beyond Q13');
q13_assert((preg_match('/Quality Platform Q1-Q([0-9]+) are \\*\\*DONE \\/ VERIFIED\\*\\*\\./', $readme, $q13_readme_range_matches) === 1 && isset($q13_readme_range_matches[1]) && (int) $q13_readme_range_matches[1] > 13), 'README advances beyond Q13');

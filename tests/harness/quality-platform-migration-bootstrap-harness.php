...
q10_assert(q10_contains($quality, '**Status:** Q14 / IMPLEMENTATION'), 'quality record advances beyond Q10');
q10_assert(q10_contains($status, '| Current program gate | **Full Automated Quality Platform — Q14** |'), 'project status advances beyond Q10');
q10_assert(q10_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q14**.'), 'README advances beyond Q10');

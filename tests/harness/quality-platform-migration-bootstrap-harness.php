...
q10_assert(q10_contains($quality, '**Status:** Q13 / IMPLEMENTATION'), 'quality record advances beyond Q10');
q10_assert(q10_contains($status, '| Current program gate | **Full Automated Quality Platform — Q13** |'), 'project status advances beyond Q10');
q10_assert(q10_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q13**.'), 'README advances beyond Q10');

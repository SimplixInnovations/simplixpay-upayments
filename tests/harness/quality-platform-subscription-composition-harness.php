...
q11_assert(q11_contains($status, '| Quality Platform Q16 migration-core analysis | **DONE / VERIFIED** |'), 'project status advances beyond Q11');
q11_assert((preg_match('/Quality Platform Q1-Q([0-9]+) are \\*\\*DONE \\/ VERIFIED\\*\\*\\./', $readme, $q11_readme_range_matches) === 1 && isset($q11_readme_range_matches[1]) && (int) $q11_readme_range_matches[1] > 11), 'README advances beyond Q11');

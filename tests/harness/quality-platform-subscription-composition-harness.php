...
q11_assert(q11_contains($quality, '**Status:** Q15 / IMPLEMENTATION'), 'quality record advances beyond Q11');
q11_assert(q11_contains($status, '| Current program gate | **Full Automated Quality Platform — Q15** |'), 'project status advances beyond Q11');
q11_assert(q11_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q15**.'), 'README advances beyond Q11');

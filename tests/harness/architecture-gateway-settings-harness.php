...
a3_assert_same(
    array(array('woocommerce_admin_styles', '.upayments-disabled-setting { opacity: 0.5; pointer-events: none; }')),
    $a3_assets['inline'],
    'broader checkout-tab inline style retains its exact handle and bytes'
);
...
a3_assert(strpos($module_source, 'namespace Simplixi\\SUCheckout\\UPayments\\Admin;') !== false, 'settings module uses canonical SUPCheckout Admin namespace');

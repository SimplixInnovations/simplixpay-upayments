...
q2_assert(
    ...
    q2_contains($quality_record, '**Status:** Q14 / IMPLEMENTATION'),
...
q2_assert(q2_contains($status, '| Current program gate | **Full Automated Quality Platform — Q14** |'), 'project status advances beyond Quality Platform Q2');
q2_assert(q2_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q14**.'), 'README advances beyond Quality Platform Q2');

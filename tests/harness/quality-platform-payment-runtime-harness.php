...
q17_assert(
    q17_blob($root . '/includes/Subscription/Cron/Scheduler.php') === '348fa0a2183be5a9b5897d6bd355fbaf902d8948',
...
q17_assert(q17_has($status, '| Production maturity | **Pre-release / SUCheckout migration implemented; exact-head certification required** |'), 'project status advances beyond Q17 into implemented SUCheckout migration with permanent certification');

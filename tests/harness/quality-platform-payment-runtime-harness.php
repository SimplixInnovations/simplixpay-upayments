...
q17_assert(q17_has($status, '| Production maturity | **Pre-release / SUCheckout migration merged and post-merge certified** |'), 'project status advances beyond Q17 into implemented SUCheckout migration with permanent certification');

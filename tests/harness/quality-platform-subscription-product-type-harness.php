...
q12_assert(q12_contains($quality, '**Status:** Q16 / IMPLEMENTATION'), 'quality record advances beyond Q12');
q12_assert(q12_contains($status, '| Current program gate | **Full Automated Quality Platform — Q16** |'), 'project status advances beyond Q12');
q12_assert(q12_contains($readme, 'The current program gate is **Full Automated Quality Platform — Q16**.'), 'README advances beyond Q12');

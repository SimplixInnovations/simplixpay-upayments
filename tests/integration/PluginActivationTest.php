...
if ('seed' === $phase) {
    ...
    sucheckout_cert_assert(is_int($checkout_page_id) && $checkout_page_id > 0, 'WooCommerce checkout page exists before SUPCheckout activation');
...
if ('verify' === $phase) {
    ...
    sucheckout_cert_assert(class_exists('WC_Upayments'), 'SUPCheckout Classic gateway class loads in the real WooCommerce runtime');
    ...
    sucheckout_cert_assert($gateways['upayments'] instanceof WC_Upayments, 'registered Classic gateway is the SUPCheckout gateway instance');

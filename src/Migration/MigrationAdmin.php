...
final class MigrationAdmin {
    ...
    public static function render() {
        ...
        echo '<tr><th scope="row"><label for="simplixpay-user-ids">' . esc_html__('User IDs', 'sucheckout-upayments') . '</label></th><td>';
        ...
        echo '<tr><th scope="row"><label for="simplixpay-offset">' . esc_html__('Explicit offset', 'sucheckout-upayments') . '</label></th><td>';
        ...
        echo '<tr><th scope="row"><label for="simplixpay-limit">' . esc_html__('Batch limit', 'sucheckout-upayments') . '</label></th><td>';

...
6. [`MASTER-ENGINEERING-PLAYBOOK.md`](MASTER-ENGINEERING-PLAYBOOK.md) — full program, quality standards and release gates.
7. [`BASELINE-H12.md`](BASELINE-H12.md) — canonical-root and H12 provenance/evidence anchors.
...
5. `MASTER-ENGINEERING-PLAYBOOK.md` controls the broader program unless a later explicitly approved status/ADR updates a gate.
6. Historical records are evidence; do not rewrite them merely to make the project look further along.

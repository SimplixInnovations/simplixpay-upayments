...
PR #61 removed remaining retired pre-rebrand first-party constants and certification-control prefixes while preserving protected provider/persisted UPayments identities.

...
The implementation gate immediately following Phase 0 was **Phase 9I — Historical token-identity migration**. Phase 9I, Provider Contract & Payment Lifecycle, the bounded Security Threat-Model Closure and Architecture discovery are now **DONE / VERIFIED**; the current permitted gate is **Architecture & Code-Quality Foundation — A1**, under the same protected-branch review/CI discipline and frozen compatibility contracts.

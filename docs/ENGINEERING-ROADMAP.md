...
6. **Full Automated Quality Platform — CURRENT GATE / Q6**
   ...
   - Q6 gateway settings schema/validation/sanitation/rendering/admin-asset characterization and baseline-free analysis: **CURRENT**;
   - PHPUnit;
